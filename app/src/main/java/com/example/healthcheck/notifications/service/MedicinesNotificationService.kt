package com.example.healthcheck.notifications.service
...
import com.example.data.MEDICINES_CHANNEL
import com.example.data.MESSAGE
import com.example.healthcheck.R
import com.example.healthcheck.notifications.receiver.MedicinesNotificationReceiver
import com.example.healthcheck.ui.main.MainActivity
...
class MedicinesNotificationService(private val context: Context) {
    ...
    fun showNotification(message: String, channelID : Int) {
        ...
        val notification = NotificationCompat.Builder(context, MEDICINES_CHANNEL)
